...
import { LmsPlatformAccessory } from './platformAccessory';
    ...
    discoverSlimServer()
      ...
      .then(players => {
        ...
        for (const device of players) {
          ...
          const uuid = this.api.hap.uuid.generate(device.player_id);
          ...
          if (existingAccessory) {
            ...
            new LmsPlatformAccessory(this, existingAccessory, device.host);
            ...
            // this is imported from `platformAccessory.ts`
            new LmsPlatformAccessory(this, accessory, device.host);
